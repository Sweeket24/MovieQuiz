...
// Протокол для тестов
protocol TestNetworkRouting {
    func fetch(url: URL, handler: @escaping (Result<Data, Error>) -> Void)
}

// Приведение протоколов
extension NetworkClient: TestNetworkRouting {}

final class StubNetworkClient: TestNetworkRouting {
...
class MoviesLoaderTests: XCTestCase {
    func testSuccessLoading() throws {
        ...
        // Создаем MoviesLoader с кастомным инициализатором
